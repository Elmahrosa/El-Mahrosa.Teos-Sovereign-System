...
Retention Policy
Audit logs are retained for a minimum of 7 years on a separate, immutable storage system to meet regulatory compliance requirements. Local development logs are for debugging only and should not be relied upon for official audits.
Plain Text
